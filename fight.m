...
Kp_base = 1 * Mrb;  % Increased proportional gain
Kd_base = 1 * Mrb;  % Increased derivative gain
% Simulation settings
T = 120;
dt = 0.005;
t = 0:dt:T;
...
%     eta(2,i+1) = etad(2,i);  % Force y to follow desired
    ...
    % Remove angular velocity constraints
...
video = VideoWriter([trajectory_type '_trajectory_free.avi']);
video.FrameRate = 30;
open(video);
